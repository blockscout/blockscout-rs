pub use s3_storage::{
    initialize_s3_storage, initialize_s3_storage_and_return_settings, is_s3_storage_empty,
};
mod s3_storage {
    ...
    pub async fn initialize_s3_storage_and_return_settings(test_name: &str) -> S3StorageSettings {
    ...
    async fn initialize_client(test_name: &str) -> ClientWithDetails {
        ...
        let bucket_name = test_name.replace("_", "-").replace("/", "-");
