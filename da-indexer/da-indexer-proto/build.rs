...
fn compile(
    ...
    config
        ...
        .protoc_arg("grpc_api_configuration=proto/v1/api_config_http.yaml,output_format=yaml,allow_merge=true,merge_file_name=da-indexer")
        .bytes(["."])
        .btree_map(["."])
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    compile(
        &["proto/v1/da-indexer.proto", "proto/v1/health.proto"],
        &["proto"],
        gens,
    )?;
    Ok(())
