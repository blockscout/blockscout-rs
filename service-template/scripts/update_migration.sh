...
MIGRATION_NAME="$1"
MIGRATION_DIR="{{project-name}}-migration"
...
# The output format is: "Creating migration file `{{project-name}}-migration/src/m20250801_123141_hello.rs`"
...
# From: {{project-name}}-migration/src/m20250801_123141_hello.rs
