...
mod tests {
    ...
    async fn handle_tx_v06_ok() {
        ...
        assert_eq!(user_op, UserOp {
            ...
            block_hash: BlockHash::from_str("0xe90aa1d6038c87b029a0666148ac2058ab8397f9c53594cc5a38c0113a48eab4").unwrap(),
    ...
    async fn handle_tx_v06_with_tracing_ok() {
        ...
        // just some random tx from mainnet
        let tx_hash =
            TxHash::from_str("0xd69a2233e7ff9034d21f588ffde16ef30dee6ddc4814fa4ecd4a1355630b1730")
                .unwrap();
        let entry_point = EntrypointsSettings::default().v06_entry_point;
        let op_hash =
        ...
        for trace_client in [TraceClient::Geth, TraceClient::Parity] {
            ...
            assert_eq!(user_op, UserOp {
                hash: op_hash,
                sender: Address::from_str("0xc09521aa72df1f93e36c776d5464f8bf2ae7b37d").unwrap(),
                nonce: B256::from_str("0x0000000000000000000000000000000000000000000021050000000000000002").unwrap(),
                init_code: None,
                ...
                block_hash: BlockHash::from_str("0x2389d13b5294f5c38f5120671adf870468d892e60e637cb65e0eb47c455160f9").unwrap(),
                bundler: Address::from_str("0xc09521aa72df1f93e36c776d5464f8bf2ae7b37d").unwrap(),
                bundle_index: 0,
                index: 0,
                factory: None,
                paymaster: None,
    ...
    async fn handle_tx_v07_ok() {
        ...
        // just some random tx from mainnet
        let tx_hash =
            TxHash::from_str("0x4a6702f8ef5b7754f5b54dfb00ccba181603e3a6fff77c93e7d0d40148f09ad0")
                .unwrap();
        ...
        let op_hash =
            B256::from_str("0xbd48a68e7dd39891fe7f139fe11bfb82d934a5deceb98f0c6fc4ebc7eeca58da")
                .unwrap();
        let user_op = repository::user_op::find_user_op_by_op_hash(&db, op_hash)
            .await
            .unwrap()
        ...
        assert_eq!(user_op, UserOp {
            hash: op_hash,
            sender: Address::from_str("0x4a7EFb490b2D34D1962f365C5647D84FAdD3Bd6A").unwrap(),
            nonce: B256::from_str("0x00005c97aa67ba578e3c54ec5942a7563ea9130e4f5f4c300000000000000000").unwrap(),
            init_code: None,
            ...
            signature: Bytes::from_str("0xf59f5f4d934312578dbd0c7a8a464cd8c73c1cbbb267b1dcae103d0e2d8f3971314b169eac449874652d7f6cb83de63422c762c4dfbca02629f94fc3a478141d1c").unwrap(),
            aggregator: None,
            aggregator_signature: None,
            entry_point,
            ...
            block_hash: BlockHash::from_str("0x54f26503211219a84c1c25d8f5c61d6e1a2f253b97508fb88a6e2e13bffee0b3").unwrap(),
            bundler: Address::from_str("0x4337003fcD2F56DE3977cCb806383E9161628D0E").unwrap(),
            bundle_index: 0,
            index: 0,
            factory: None,
            paymaster: Some(Address::from_str("0x0000000000000039cd5e8aE05257CE51C473ddd1").unwrap()),
            status: true,
            revert_reason: None,
