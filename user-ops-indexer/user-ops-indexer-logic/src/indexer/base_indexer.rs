...
mod tests {
    ...
    async fn handle_tx_v07_ok() {
        ...
        assert_eq!(user_op, UserOp {
            ...
            max_fee_per_gas: U256::from(5095252459u64),
            max_priority_fee_per_gas: U256::from(1000000),
    ...
    async fn handle_tx_v08_ok() {
        ...
        assert_eq!(user_op, UserOp {
            ...
            max_fee_per_gas: U256::from(1550845482),
            max_priority_fee_per_gas: U256::from(1500000000),
            paymaster_and_data: None,
