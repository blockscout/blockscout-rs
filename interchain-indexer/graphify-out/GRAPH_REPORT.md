...
## Corpus Check
- 304 files · ~333,136 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4327 nodes · 10302 edges · 259 communities (202 shown, 34 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 677 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bafd62f7`
...
Cohesion: 0.14
Nodes (12): kickoff_enrichment_no_token_service_is_noop(), Arc, DatabaseTransaction, DbErr, Default, NaiveDate, Option, Result (+4 more)

### Community 3 - ".new"
Cohesion: 0.09
Nodes (60): ChainBridgeFilter, Option, Vec, counters_cover_all_filters(), default_filter(), InterchainTotalCounters, message_ids(), mock_db_upsert_chain() (+52 more)
...
Cohesion: 0.07
Nodes (45): BackfillStatsReport, BridgeChainUserCountRow, build_all_time_message_paths_query(), build_bounded_message_paths_query(), CrosschainMessageLookup, expect_found(), get_crosschain_message_native_collision_is_ambiguous_until_qualified(), get_crosschain_message_numeric_collision_is_ambiguous_until_qualified() (+37 more)

### Community 7 - "init_db"
Cohesion: 0.09
Nodes (73): completed_message(), completed_message_at(), completed_message_without_indexed_source(), insert_already_processed_bridging_transfer(), load_native_id_map_filters_missing_native_ids(), message_paths_invalid_or_empty_range_returns_empty(), ActiveModel, DatabaseConnection (+65 more)
...
Cohesion: 0.16
Nodes (34): InterchainDailyCounters, message_paths_bounded_queries_apply_open_and_half_open_ranges(), message_paths_bounded_queries_sum_daily_rows_and_order_deterministically(), message_paths_default_excludes_pair_unindexed_for_its_bridge(), message_paths_empty_configured_pairs_restricts_nothing(), message_paths_include_zero_bounded_counterparty_expands_requested_known_rows_only(), message_paths_include_zero_bounded_queries_expand_known_chains(), message_paths_include_zero_counterparty_expands_requested_known_rows_only() (+26 more)
...
Cohesion: 0.12
Nodes (16): AmbIndexer, AbiRegistry, Arc, AtomicBool, AtomicU64, DashMap, JoinHandle, Message (+8 more)
...
Cohesion: 0.07
Nodes (77): a_drain_keeps_events_queued_during_its_awaits(), a_failed_drain_keeps_the_queued_events_for_the_replay(), a_successful_drain_removes_the_queue_entry(), alter_amb(), apply_collected_signatures(), apply_validator_confirmation(), collected_signatures_identity(), confirmation_for() (+69 more)
...
### Community 57 - "provider_layers.rs"
Cohesion: 0.19
...
Cohesion: 0.26
Nodes (27): addr(), destination(), destination_transfer(), hash(), is_collision(), record_conflict(), Address, B256 (+19 more)
...
Cohesion: 0.29
Nodes (8): OutputPagination, P, StatsChainsPaginationLogic, StatsChainsSortField, build_pagination(), Option, StatsChainListRow, StatsChainsScope

### Community 66 - "amb/indexer.rs"
Cohesion: 0.26
...
### Community 68 - "Result"
Cohesion: 0.09
Nodes (22): BridgedTokensListPagination, build_pagination_from_bridged_tokens(), build_pagination_from_messages(), build_pagination_from_transfers(), BridgedTokensPaginationLogic, ListMarker, MessagesPaginationLogic, OutputPagination<P> (+14 more)
...
### Community 82 - "build_layered_provider_from_services"
Cohesion: 0.19
...
Cohesion: 0.13
Nodes (15): ADR-002: Per-Bridge Chain Filtering, Fail-Fast Startup Validation of home_chain_id, Filter Order: Chain-Config Then Home-Chain, home_chain_id, process_unknown_chains, ADR-004: Observability Horizon and Asset Union-Find, Config Change Never Reinterprets Indexed History, include_unindexed_chains Read Filter (+7 more)
...
Cohesion: 0.12
Nodes (18): Drain Must Not Clear Its Queue Before Writes Succeed, FailureLedger, indexer_failures Table, LogBatch (from_block, to_block, direction, logs), LogStream, interchain_indexer_oldest_open_hole_age_seconds, One Scanner Per (bridge, chain), RangeDriver (+10 more)

### Community 100 - ".dispatch"
Cohesion: 0.23
...
### Community 105 - "Architectural Decision Records Index"
Cohesion: 0.17
...
Cohesion: 0.07
Nodes (63): chain_config(), Vec, affirmation_completed_log(), block_with_timestamp(), check_source_asset_matches_latest(), collected_signatures_before_its_source_is_queued_then_drained_to_ready_to_claim(), collected_signatures_log(), completed_transfer_reaches_two_assets_joined_by_a_conversion_edge() (+55 more)
...
### Community 131 - "FailureRetrySettings"
Cohesion: 0.29
...
### Community 136 - ".recompute_stats_chains"
Cohesion: 0.18
...
### Community 159 - "Key"
Cohesion: 0.11
Nodes (27): new_transfer(), ActiveModel, amount_to_decimal(), build_destination_only(), build_destination_only_transfer(), build_source_led(), build_transfer(), destination_anomaly() (+19 more)
...
### Community 206 - "AmbDispatchMockService"
Cohesion: 0.20
Nodes (10): Id, AmbDispatchMockService, json_response(), Block, Future, RequestPacket, ResponsePacket, Service (+2 more)
...
Cohesion: 0.17
Nodes (17): BridgedTokenAggDbRow, BridgedTokenLinkEnriched, count_column(), cursor_where_next(), cursor_where_prev(), Option, String, Value (+9 more)
...
### Community 218 - "Gotcha: Recoverable Message Fields Are Not A "Never Mirror" Case"
Cohesion: 0.25
...
### Community 219 - "ChainInfoServiceSettings"
Cohesion: 0.43
...
### Community 252 - "prelude.rs"
Cohesion: 0.10
Nodes (13): Date, Model, Relation, DateTime, Model, Relation, DateTime, Model (+5 more)
...
- **Why does `InterchainDatabase` connect `InterchainDatabase` to `StatsService`, `.new`, `persistence.rs`, `init_db`, `.recompute_stats_chains`, `.new`, `ExampleIndexer`, `log_stream.rs`, `ChainInfoService`, `.upsert_chains`, `InterchainServiceImpl`, `indexers.rs`, `MessageBuffer`, `Status`, `AmbIndexer`, `AvalancheIndexer`, `TokenInfoService`, `blockchain_id_resolver.rs`, `OutputPagination`, `retry_scheduler.rs`, `BridgedTokensSortField`, `.record_indexer_failures`, `.get_checkpoint`, `XDaiIndexer`?**
  _High betweenness centrality (0.186) - this node is a cross-community bridge._
- **Why does `Key` connect `Key` to `AmbIndexer`, `XDaiIndexer`, `persistence.rs`, `MessageBuffer`, `amb/events.rs`, `SourceData`, `Option`, `BufferItem`, `range_driver.rs`, `native_id_blob`, `avalanche/consolidation.rs`, `amb/consolidation.rs`, `avalanche/mod.rs`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `init_db()` connect `init_db` to `amb/indexer.rs`, `.new`, `persistence.rs`, `StatsService`, `.record_indexer_failures`, `InterchainDatabase`, `.recompute_stats_chains`, `ChainInfoService`, `bridged_tokens_query.rs`, `BufferItem`, `.upsert_chains`, `.get_checkpoint`, `.new`, `stats_chains_query.rs`, `range_driver.rs`, `TokenInfoService`, `MessageBuffer`, `XDaiIndexer`?**
