...
## Corpus Check
- 243 files · ~233,462 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3350 nodes · 7941 edges · 202 communities (174 shown, 28 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 554 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `634b88cd`
...
### Community 0 - "events.rs"
Cohesion: 0.13
Nodes (47): DynSolValue, a_failed_drain_keeps_the_queued_events_for_the_replay(), a_successful_drain_removes_the_queue_entry(), alter_amb(), apply_collected_signatures(), apply_validator_confirmation(), DestinationKind, dispatch_transaction() (+39 more)
...
Cohesion: 0.08
Nodes (60): build_pagination_from_messages(), build_pagination_from_transfers(), counters_cover_all_filters(), default_filter(), InterchainDailyCounters, InterchainTotalCounters, JoinedTransfer, message_ids() (+52 more)
...
### Community 10 - "Result"
Cohesion: 0.11
Nodes (19): BridgedTokensListPagination, ListMarker, MessagesPaginationLogic, OutputPagination<P>, PaginationDirection, Default, Display, Formatter (+11 more)
...
Cohesion: 0.07
Nodes (21): fixture_vars(), IndexerType, load_chains_impl(), log_applied_overrides(), ranked_names(), Item, Iterator, test_load_bridges_impl_inline_json_abi_from_env_parses() (+13 more)
...
Cohesion: 0.05
Nodes (94): Bytes, CallFailed, CallSucceeded, addr(), build_reconstructed_transfer(), build_transfer(), call_outcome_transfer(), ClassifiedPayload (+86 more)

### Community 28 - "Settings"
Cohesion: 0.06
Nodes (53): ActiveValue, DatabaseSettings, Deserialize, FnOnce, T, set_value(), DummyMessage, MessageBuffer<T> (+45 more)
...
Cohesion: 0.24
Nodes (22): handle_log(), handle_message_executed(), handle_message_execution_failed(), handle_receive_cross_chain_message(), handle_send_cross_chain_message(), LogHandleContext, parse_execution_outcome_log(), parse_message_key() (+14 more)
...
### Community 35 - "amb/consolidation.rs"
Cohesion: 0.28
...
Cohesion: 0.15
Nodes (18): AnnotatedEvent, AnnotatedICTTSource, Message, Address, B256, NaiveDateTime, Option, ReceiveCrossChainMessage (+10 more)

### Community 37 - "BridgeConfig"
Cohesion: 0.17
Nodes (21): D, BridgeConfig, bridges::ActiveModel, collect_json_files(), deserialize_abi(), deserialize_address(), deserialize_bridge_type(), load_bridges_from_file() (+13 more)
...
Cohesion: 0.06
Nodes (55): Claude Code Overrides (project CLAUDE.md), Handoff Preparation, Not Re-Analysis, Claude Skill: implementation-plan, Reviewer-Facing PR Description (not a changelog), Claude Skill: pr-description, Claude Skill: research-scope, Claude Skill: solution-review, Verification Gap Reporting (+47 more)
...
Cohesion: 0.08
Nodes (30): Bridge, Bridge Contract, Configured Chain, Consolidation, Countable / Deferred (Stats), Cross-Chain Message, Cross-Chain Transfer, Destination-Indexed Data (+22 more)

### Community 43 - "ChainConfig"
Cohesion: 0.26
Nodes (14): ApiKeyConfig, build_rpc_url(), ChainConfig, chains::ActiveModel, create_provider_pools_from_chains(), ExplorerConfig, ranked_rpc_providers(), RpcProviderConfig (+6 more)
...
### Community 48 - "indexers.rs"
Cohesion: 0.13
Nodes (35): BridgeType, amb_contract_configs(), bridge(), build_amb_chain_configs(), build_avalanche_chain_configs(), chain_config_fixture(), ChainPlan, checkpoint_floor() (+27 more)
...
### Community 52 - "AvalancheRangeProcessor"
Cohesion: 0.20
Nodes (13): AvalancheChainConfig, AvalancheRangeProcessor, BatchProcessContext, chain(), process_batch(), Address, DynProvider, Ethereum (+5 more)

### Community 53 - "FailureLedger"
Cohesion: 0.15
Nodes (11): FailureLedger, Arc, HashSet, Result, RwLock, Self, String, Vec (+3 more)
...
Cohesion: 0.09
Nodes (23): Error Handling Rules, anyhow::Result for Internal Code, API Error Sanitization, Checked/Saturating Arithmetic and Euclidean Division, DecimalsConflict Domain Marker Type, Always Add Context When Propagating, Expected Skips Inside a Shared Transaction, Log Errors at the Handling Point (+15 more)

### Community 60 - "range_driver.rs"
Cohesion: 0.15
Nodes (17): a_budget_covering_the_whole_queue_attempts_each_position_once(), chunk_range(), chunk_range_clamps_a_zero_batch_size_to_one(), chunk_range_narrower_than_batch_size_yields_one_chunk(), chunk_range_splits_into_batch_size_pieces_with_a_narrower_last_chunk(), interval(), ReplayTestMessage, resume_index() (+9 more)

### Community 61 - "TestRangeProcessor"
Cohesion: 0.09
Nodes (23): AtomicUsize, attributed_ranges(), BatchError, RangeDriver<P>, RangeProcessor, Error, Filter, From (+15 more)

### Community 62 - "Exploration Map"
Cohesion: 0.14
Nodes (19): ADR-004: Stats Observability Horizon; Asset Identity As Union-Find, IndexedChains (Stats Eligibility), API Serving Entrypoints, Avalanche Indexing Entrypoints, Common Indexer Architecture Entrypoints, Config Loading Entrypoints, Database Schema and Migrations Entrypoints, Exploration Map (+11 more)

### Community 63 - "Key"
Cohesion: 0.18
Nodes (19): amount_to_decimal(), build_destination_only(), build_destination_only_transfer(), build_source_led(), build_transfer(), destination_anomaly(), Message, ActiveModel (+11 more)
...
Cohesion: 0.13
Nodes (15): AvalancheIndexer, IndexerCleanupGuard, log_filter_covers_every_configured_contract_address_for_a_chain_with_several(), Arc, AtomicBool, AtomicU64, ChainId, Drop (+7 more)
...
Cohesion: 0.18
Nodes (6): Model, Relation, DateTime, Model, Relation, DateTime

### Community 79 - "Checkpoint"
Cohesion: 0.15
Nodes (17): A failed floor write stays a warn (today), Checkpoint, Gotcha: AMB Queued Events Must Preserve Their Emitting Chain, blockchain_id_resolver.rs — BlockchainIdResolver mapping persistence, Gotcha: A Checkpoint Certifies Scanning, Not Correctness, Gotcha: Checkpoint Stall When All Events Are Perpetually Filtered, Gotcha: Cross-Bridge Resolver Persistence Leaks (BlockchainIdResolver global cache), FailureLedger — in-memory open-hole cache over indexer_failures (+9 more)
...
Cohesion: 0.14
Nodes (15): Incoming ICTT Reconstruction / ICM Payload Decoding Entrypoints, Whole-System Entrypoints, Finality, Gotcha: abi_decode_validate Does Not Reject Trailing Bytes, ictt_completeness / classify_payload (consolidation.rs), ictt_payload.rs — TeleporterMessage payload decoder (decode_transferrer_message / decode_inner), Gotcha: Message Finality is Complex — ICM payload kind decides ICTT completeness, Configuration Model (+7 more)
...
Cohesion: 0.17
Nodes (11): BridgeContractConfig, ActiveModel, Model, Self, test_bridge_contract_config_to_active_model(), contract(), contract_with_address(), parse_contract_abi() (+3 more)
...
Cohesion: 0.21
Nodes (14): BridgedTokenAggDbRow, build_pagination_from_bridged_tokens(), count_column(), cursor_where_next(), cursor_where_prev(), String, Value, BridgedTokensPaginationLogic (+6 more)
...
Cohesion: 0.24
Nodes (9): String, bytes_to_naive_datetime(), naive_datetime_to_bytes(), naive_datetime_to_nanos(), nanos_to_naive_datetime(), NaiveDateTime, Result, test_naive_datetime_to_bytes_round_trip() (+1 more)
...
### Community 159 - "gate_receiver_ictt_arm"
Cohesion: 0.47
Nodes (6): gate_receiver_ictt_arm(), source_less_withdrawn_arm(), test_gate_receiver_ictt_arm_disabled_source_configured_preserves_arm(), test_gate_receiver_ictt_arm_disabled_source_unknown_drops_arm(), test_gate_receiver_ictt_arm_disabled_source_unknown_no_arm_does_not_increment(), test_gate_receiver_ictt_arm_enabled_preserves_arm_either_way()
...
- **Why does `InterchainDatabase` connect `InterchainDatabase` to `TokenInfoService`, `fill_mock_interchain_database`, `persistence.rs`, `init_db`, `.new`, `ExampleIndexer`, `log_stream.rs`, `ChainInfoService`, `.new`, `InterchainServiceImpl`, `reconcile_catchup_floors`, `Settings`, `.new`, `AmbIndexer`, `indexers.rs`, `FailureLedger`, `AvalancheIndexer`, `BlockchainIdResolver`, `.get_checkpoint`, `.record_indexer_failures`, `stats_processed_repeated_increments_increase_value`?**
  _High betweenness centrality (0.220) - this node is a cross-community bridge._
- **Why does `IndexedChains` connect `indexed_chains.rs` to `.new`, `Status`, `TokenInfoService`, `fill_mock_interchain_database`, `InterchainDatabase`, `init_db`, `services/utils.rs`, `projection.rs`, `bridged_tokens_query.rs`, `.new`, `InterchainServiceImpl`, `bridge_model_to_proto`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `Key` connect `Key` to `events.rs`, `AmbIndexer`, `amb/consolidation.rs`, `persistence.rs`, `BufferItem`, `maintenance.rs`, `Settings`, `AvalancheRangeProcessor`, `MaintenancePlan`, `avalanche/consolidation.rs`, `range_driver.rs`, `avalanche/mod.rs`?**
