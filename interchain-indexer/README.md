...
| `INTERCHAIN_INDEXER__AVALANCHE_INDEXER__FAILURE_RETRY__SPLIT_AFTER_ATTEMPTS`         |                          | Initial ledger record plus fully unsuccessful replay sweeps before request width starts halving.                                                                                                                                                                                                                                                                                     | `3`           |
...
| `INTERCHAIN_INDEXER__AMB_INDEXER__FAILURE_RETRY__SPLIT_AFTER_ATTEMPTS`         |                          | Initial ledger record plus fully unsuccessful replay sweeps before request width starts halving.                                                                                                                                                                                                                                                                                     | `3`           |
