...
CREATE TABLE "auth_tokens" (
  "id" INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "token_value" UUID DEFAULT (gen_random_uuid()),
...
CREATE TABLE "user_actions" (
  "id" INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "token_id" int REFERENCES "auth_tokens" ("id"),
  "created_at" timestamp NOT NULL DEFAULT (CURRENT_TIMESTAMP),
...
CREATE TABLE "instances" (
  ...
  "creator_token_id" int REFERENCES "auth_tokens" ("id"),
...
CREATE TABLE "deployments" (
  ...
  "server_spec_id" int REFERENCES "server_specs" ("id"),
  "user_config" jsonb NOT NULL DEFAULT '{}',
  "parsed_config" jsonb NOT NULL DEFAULT '{}',
  "created_at" timestamp NOT NULL DEFAULT (CURRENT_TIMESTAMP),
