...
fn compile(
    ...
    config
        ...
        .protoc_arg("grpc_api_configuration=proto/v1/api_config_http.yaml,output_format=yaml,allow_merge=true,merge_file_name=scoutcloud,json_names_for_fields=false")
        .bytes(["."])
        .btree_map(["."])
