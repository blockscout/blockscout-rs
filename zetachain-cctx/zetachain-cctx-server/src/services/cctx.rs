...
use zetachain_cctx_proto::blockscout::zetachain_cctx::v1::{
    ...
    RelatedCctx, RelatedOutboundParams, RevertOptions, Status as CCTXStatus,
};
...
impl CctxInfo for CctxService {
    async fn list_cctxs(
        ...
        let filters = Filters {
            ...
            source_chain_id: parse_comma_separated(request.source_chain_id),
            target_chain_id: parse_comma_separated(request.target_chain_id),
