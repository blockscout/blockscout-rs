...
export let BASE_NODE_HASH =
  "579b8f9e035be78f0cb224078921fdb583c2cdbf8123eb841806cd16422e5b0b"; // mainnet base node hash

// @ts-ignore
if (NETWORK == "taiko-testnet") {
  // TODO: add testnet base node hash
  BASE_NODE_HASH = "";
}

export const BASE_NODE = ".taiko";
export const COIN_TYPE = 2147650648; // 167000
export const COIN_TYPE_SEPOLIA = 2147650648; // 167000, not sure how can we get this
