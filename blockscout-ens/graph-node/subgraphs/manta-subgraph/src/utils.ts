...
export let BASE_NODE_HASH =
  "45d521addba42ee6b4235c68a80f92fef701db1064f4138ba394019ec4aae040"; // mainnet base node hash

// @ts-ignore
if (NETWORK == "manta-testnet") {
  // TODO: add testnet base node hash
  BASE_NODE_HASH = "";
}

export const BASE_NODE = ".manta";
export const COIN_TYPE = 2147483817; // 169
export const COIN_TYPE_SEPOLIA = 2147483817; // 169 To be fixed
