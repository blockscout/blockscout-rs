...
export class Domain extends Entity {
  ...
  get storedOffchain(): boolean {
    let value = this.get("storedOffchain");
    if (!value || value.kind == ValueKind.NULL) {
      return false;
    } else {
      return value.toBoolean();
  ...
  set storedOffchain(value: boolean) {
    this.set("storedOffchain", Value.fromBoolean(value));
  }

  get resolvedWithWildcard(): boolean {
    let value = this.get("resolvedWithWildcard");
    if (!value || value.kind == ValueKind.NULL) {
      return false;
    } else {
      return value.toBoolean();
  ...
  set resolvedWithWildcard(value: boolean) {
    this.set("resolvedWithWildcard", Value.fromBoolean(value));
  }
}
