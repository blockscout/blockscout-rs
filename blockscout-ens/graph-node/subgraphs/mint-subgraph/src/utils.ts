...
export let BASE_NODE_HASH = "812b44f117ff923f57c0461e3bbfe7f5e054d8ea1c2e365ad3ac2fd9e9c013a2" // mainnet base node hash

// @ts-ignore
if (NETWORK == "mint-testnet") {
  // TODO: add testnet base node hash
  BASE_NODE_HASH = "";
}

export const BASE_NODE = ".mint";
export const COIN_TYPE      = 2147483833 // 185
export const COIN_TYPE_SEPOLIA      = 2147484727 // 1079
