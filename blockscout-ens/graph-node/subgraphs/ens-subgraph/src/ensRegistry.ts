...
export function handleNewResolverOldRegistry(event: NewResolverEvent): void {
  // there is some bug with new_resolver in old registry, it prints this error:
  // transaction 9f1c82138f6107fe9a01bb6780aaa3b8791931565ad33d19ac7924c6f0be4830:
  // Mapping aborted at src/ensRegistry.ts, line 246, column 16,
  // with message: unexpected null	wasm backtrace:	    0: 0x4b96 - <unknown>!src/ensRegistry/handleNewResolverOldRegistr
  return;
  let node = event.params.node.toHexString();
