...
pub enum Relation {
    ...
    Blocks,
    #[sea_orm(has_many = "super::fhe_operations::Entity")]
    FheOperations,
    #[sea_orm(has_many = "super::internal_transactions::Entity")]
    InternalTransactions,
    #[sea_orm(has_many = "super::logs::Entity")]
    Logs,
    #[sea_orm(has_one = "super::pending_transaction_operations::Entity")]
...
impl Related<super::fhe_operations::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::FheOperations.def()
    }
}
...
impl Related<super::pending_transaction_operations::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::PendingTransactionOperations.def()
    }
}
