...
pub struct SummaryVariableToken {

    
    /// CodegenProperty{openApiType='string', baseName='type', complexType='null', getter='getR#type', setter='setR#type', description='Type', dataType='String', datatypeWithEnum='String', dataFormat='null', name='r#type', min='null', max='null', defaultValue='null', defaultValueWithParam=' = data.type;', baseType='String', containerType='null', containerTypeMapped='null', title='null', unescapedDescription='Type', maxLength=null, minLength=null, pattern='null', example='token', jsonSchema='{
  "description" : "Type",
  "example" : "token",
  "type" : "string"
