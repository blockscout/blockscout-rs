...
pub trait TransactionsApi: Send + Sync {
    ...
    ///
    /// 
    async fn get_transaction_internal_txs(&self,  params: GetTransactionInternalTxsParams ) -> Result<ResponseContent<GetTransactionInternalTxsSuccess>, Error<GetTransactionInternalTxsError>>;

    /// GET /api/v2/transactions/{transaction_hash}/logs
    ///
    /// 
    async fn get_transaction_logs(&self,  params: GetTransactionLogsParams ) -> Result<ResponseContent<GetTransactionLogsSuccess>, Error<GetTransactionLogsError>>;

    /// GET /api/v2/transactions/{transaction_hash}/raw-trace
    ///
    /// 
    async fn get_transaction_raw_trace(&self,  params: GetTransactionRawTraceParams ) -> Result<ResponseContent<GetTransactionRawTraceSuccess>, Error<GetTransactionRawTraceError>>;

    /// GET /api/v2/transactions/{transaction_hash}/state-changes
    ///
    /// 
    async fn get_transaction_state_changes(&self,  params: GetTransactionStateChangesParams ) -> Result<ResponseContent<GetTransactionStateChangesSuccess>, Error<GetTransactionStateChangesError>>;

    /// GET /api/v2/transactions/{transaction_hash}/summary
    ///
    /// 
    async fn get_transaction_summary(&self,  params: GetTransactionSummaryParams ) -> Result<ResponseContent<GetTransactionSummarySuccess>, Error<GetTransactionSummaryError>>;

    /// GET /api/v2/transactions/{transaction_hash}/token-transfers
    ///
    /// 
    async fn get_transaction_token_transfers(&self,  params: GetTransactionTokenTransfersParams ) -> Result<ResponseContent<GetTransactionTokenTransfersSuccess>, Error<GetTransactionTokenTransfersError>>;

    /// GET /api/v2/transactions/{transaction_hash}
    ///
    /// 
    async fn get_tx(&self,  params: GetTxParams ) -> Result<ResponseContent<GetTxSuccess>, Error<GetTxError>>;

    /// GET /api/v2/transactions
    ///
    /// 
    async fn get_txs(&self,  params: GetTxsParams ) -> Result<ResponseContent<GetTxsSuccess>, Error<GetTxsError>>;
}
...
impl TransactionsApi for TransactionsApiClient {
    async fn get_transaction_internal_txs(&self,  params: GetTransactionInternalTxsParams ) -> Result<ResponseContent<GetTransactionInternalTxsSuccess>, Error<GetTransactionInternalTxsError>> {
        ...
        let GetTransactionInternalTxsParams {
            transaction_hash,
        } = params;
        ...
        let local_var_uri_str = format!("{}/api/v2/transactions/{transaction_hash}/internal-transactions", local_var_configuration.base_path, transaction_hash=crate::apis::urlencode(transaction_hash));
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<GetTransactionInternalTxsSuccess> = serde_json::from_str(&local_var_content).ok();
            let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Ok(local_var_result)
        } else {
            let local_var_entity: Option<GetTransactionInternalTxsError> = serde_json::from_str(&local_var_content).ok();
    ...
    async fn get_transaction_logs(&self,  params: GetTransactionLogsParams ) -> Result<ResponseContent<GetTransactionLogsSuccess>, Error<GetTransactionLogsError>> {
        ...
        let local_var_uri_str = format!("{}/api/v2/transactions/{transaction_hash}/logs", local_var_configuration.base_path, transaction_hash=crate::apis::urlencode(transaction_hash));
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<GetTransactionLogsSuccess> = serde_json::from_str(&local_var_content).ok();
            let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Ok(local_var_result)
        } else {
            let local_var_entity: Option<GetTransactionLogsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_transaction_raw_trace(&self,  params: GetTransactionRawTraceParams ) -> Result<ResponseContent<GetTransactionRawTraceSuccess>, Error<GetTransactionRawTraceError>> {
        ...
        let GetTransactionRawTraceParams {
            transaction_hash,
        } = params;
        ...
        let local_var_uri_str = format!("{}/api/v2/transactions/{transaction_hash}/raw-trace", local_var_configuration.base_path, transaction_hash=crate::apis::urlencode(transaction_hash));
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<GetTransactionRawTraceSuccess> = serde_json::from_str(&local_var_content).ok();
            let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Ok(local_var_result)
        } else {
            let local_var_entity: Option<GetTransactionRawTraceError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_transaction_state_changes(&self,  params: GetTransactionStateChangesParams ) -> Result<ResponseContent<GetTransactionStateChangesSuccess>, Error<GetTransactionStateChangesError>> {
        ...
        let GetTransactionStateChangesParams {
            transaction_hash,
        } = params;
        ...
        let local_var_uri_str = format!("{}/api/v2/transactions/{transaction_hash}/state-changes", local_var_configuration.base_path, transaction_hash=crate::apis::urlencode(transaction_hash));
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<GetTransactionStateChangesSuccess> = serde_json::from_str(&local_var_content).ok();
            let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Ok(local_var_result)
        } else {
            let local_var_entity: Option<GetTransactionStateChangesError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_transaction_summary(&self,  params: GetTransactionSummaryParams ) -> Result<ResponseContent<GetTransactionSummarySuccess>, Error<GetTransactionSummaryError>> {
        ...
        let GetTransactionSummaryParams {
            transaction_hash,
        } = params;
        ...
        let local_var_uri_str = format!("{}/api/v2/transactions/{transaction_hash}/summary", local_var_configuration.base_path, transaction_hash=crate::apis::urlencode(transaction_hash));
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<GetTransactionSummarySuccess> = serde_json::from_str(&local_var_content).ok();
            let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Ok(local_var_result)
        } else {
            let local_var_entity: Option<GetTransactionSummaryError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_transaction_token_transfers(&self,  params: GetTransactionTokenTransfersParams ) -> Result<ResponseContent<GetTransactionTokenTransfersSuccess>, Error<GetTransactionTokenTransfersError>> {
        ...
        let local_var_uri_str = format!("{}/api/v2/transactions/{transaction_hash}/token-transfers", local_var_configuration.base_path, transaction_hash=crate::apis::urlencode(transaction_hash));
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<GetTransactionTokenTransfersSuccess> = serde_json::from_str(&local_var_content).ok();
            let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Ok(local_var_result)
        } else {
            let local_var_entity: Option<GetTransactionTokenTransfersError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_tx(&self,  params: GetTxParams ) -> Result<ResponseContent<GetTxSuccess>, Error<GetTxError>> {
        ...
        let local_var_uri_str = format!("{}/api/v2/transactions/{transaction_hash}", local_var_configuration.base_path, transaction_hash=crate::apis::urlencode(transaction_hash));
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<GetTxSuccess> = serde_json::from_str(&local_var_content).ok();
            let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Ok(local_var_result)
        } else {
    ...
    async fn get_txs(&self,  params: GetTxsParams ) -> Result<ResponseContent<GetTxsSuccess>, Error<GetTxsError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<GetTxsSuccess> = serde_json::from_str(&local_var_content).ok();
            let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Ok(local_var_result)
        } else {
...
impl ResponseContent<GetTransactionInternalTxsSuccess> {
    ...
    pub fn try_parse_as_success_model(&self) -> Result<models::GetTransactionInternalTxs200Response, serde_json_path_to_error::Error> {
...
impl ResponseContent<GetTransactionLogsSuccess> {
    ...
    pub fn try_parse_as_success_model(&self) -> Result<models::GetTransactionLogs200Response, serde_json_path_to_error::Error> {
        serde_json_path_to_error::from_str(&self.content)
    }
}
...
impl ResponseContent<GetTransactionRawTraceSuccess> {
    ...
    pub fn try_parse_as_success_model(&self) -> Result<Vec<models::RawTrace>, serde_json_path_to_error::Error> {
        serde_json_path_to_error::from_str(&self.content)
    }
}
...
impl ResponseContent<GetTransactionStateChangesSuccess> {
    ...
    pub fn try_parse_as_success_model(&self) -> Result<models::GetTransactionStateChanges200Response, serde_json_path_to_error::Error> {
        serde_json_path_to_error::from_str(&self.content)
    }
}
...
impl ResponseContent<GetTransactionSummarySuccess> {
    ...
    pub fn try_parse_as_success_model(&self) -> Result<models::TransactionSummary, serde_json_path_to_error::Error> {
        serde_json_path_to_error::from_str(&self.content)
    }
}
...
impl ResponseContent<GetTransactionTokenTransfersSuccess> {
    ...
    pub fn try_parse_as_success_model(&self) -> Result<models::GetTransactionTokenTransfers200Response, serde_json_path_to_error::Error> {
        serde_json_path_to_error::from_str(&self.content)
    }
}
...
impl ResponseContent<GetTxSuccess> {
    ...
    pub fn try_parse_as_success_model(&self) -> Result<models::Transaction, serde_json_path_to_error::Error> {
        serde_json_path_to_error::from_str(&self.content)
    }
}
...
impl ResponseContent<GetTxsSuccess> {
    ...
    pub fn try_parse_as_success_model(&self) -> Result<models::GetTxs200Response, serde_json_path_to_error::Error> {
        serde_json_path_to_error::from_str(&self.content)
    }
}
