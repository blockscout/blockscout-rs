...
pub trait SmartContractsApi: Send + Sync {
    ...
    ///
    /// 
    async fn get_smart_contract(&self,  params: GetSmartContractParams ) -> Result<ResponseContent<GetSmartContractSuccess>, Error<GetSmartContractError>>;

    /// GET /api/v2/smart-contracts
    ///
    /// 
    async fn get_smart_contracts(&self,  params: GetSmartContractsParams ) -> Result<ResponseContent<GetSmartContractsSuccess>, Error<GetSmartContractsError>>;

    /// GET /api/v2/smart-contracts/counters
    ///
    /// 
    async fn get_smart_contracts_counters(&self, ) -> Result<ResponseContent<GetSmartContractsCountersSuccess>, Error<GetSmartContractsCountersError>>;
}
...
impl SmartContractsApi for SmartContractsApiClient {
    async fn get_smart_contract(&self,  params: GetSmartContractParams ) -> Result<ResponseContent<GetSmartContractSuccess>, Error<GetSmartContractError>> {
        ...
        let local_var_uri_str = format!("{}/api/v2/smart-contracts/{address_hash}", local_var_configuration.base_path, address_hash=crate::apis::urlencode(address_hash));
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<GetSmartContractSuccess> = serde_json::from_str(&local_var_content).ok();
            let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Ok(local_var_result)
        } else {
            let local_var_entity: Option<GetSmartContractError> = serde_json::from_str(&local_var_content).ok();
    ...
    async fn get_smart_contracts(&self,  params: GetSmartContractsParams ) -> Result<ResponseContent<GetSmartContractsSuccess>, Error<GetSmartContractsError>> {
        ...
        let local_var_uri_str = format!("{}/api/v2/smart-contracts", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<GetSmartContractsSuccess> = serde_json::from_str(&local_var_content).ok();
            let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Ok(local_var_result)
        } else {
            let local_var_entity: Option<GetSmartContractsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_smart_contracts_counters(&self, ) -> Result<ResponseContent<GetSmartContractsCountersSuccess>, Error<GetSmartContractsCountersError>> {
        ...
        let local_var_uri_str = format!("{}/api/v2/smart-contracts/counters", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<GetSmartContractsCountersSuccess> = serde_json::from_str(&local_var_content).ok();
            let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Ok(local_var_result)
        } else {
            let local_var_entity: Option<GetSmartContractsCountersError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
...
impl ResponseContent<GetSmartContractSuccess> {
    ...
    pub fn try_parse_as_success_model(&self) -> Result<models::SmartContract, serde_json_path_to_error::Error> {
...
impl ResponseContent<GetSmartContractsSuccess> {
    ...
    pub fn try_parse_as_success_model(&self) -> Result<models::GetSmartContracts200Response, serde_json_path_to_error::Error> {
        serde_json_path_to_error::from_str(&self.content)
    }
}
...
impl ResponseContent<GetSmartContractsCountersSuccess> {
    ...
    pub fn try_parse_as_success_model(&self) -> Result<models::GetSmartContractsCounters200Response, serde_json_path_to_error::Error> {
        serde_json_path_to_error::from_str(&self.content)
    }
}
