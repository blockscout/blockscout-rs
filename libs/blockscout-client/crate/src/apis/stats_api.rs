...
impl StatsApi for StatsApiClient {
    async fn get_market_chart(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<GetMarketChartSuccess> =
    ...
    async fn get_stats(&self) -> Result<ResponseContent<GetStatsSuccess>, Error<GetStatsError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetStatsError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    async fn get_txs_chart(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<GetTxsChartSuccess> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_result = ResponseContent {
                status: local_var_status,
                content: local_var_content,
...
impl ResponseContent<GetMarketChartSuccess> {
    ...
    pub fn try_parse_as_success_model(
        &self,
    ) -> Result<models::GetMarketChart200Response, serde_json_path_to_error::Error> {
...
impl ResponseContent<GetStatsSuccess> {
    ...
    pub fn try_parse_as_success_model(
        &self,
    ) -> Result<models::StatsResponse, serde_json_path_to_error::Error> {
        serde_json_path_to_error::from_str(&self.content)
    }
}
...
impl ResponseContent<GetTxsChartSuccess> {
    ...
    pub fn try_parse_as_success_model(
        &self,
    ) -> Result<models::GetTxsChart200Response, serde_json_path_to_error::Error> {
        serde_json_path_to_error::from_str(&self.content)
    }
}
