...
pub trait CelestiaServiceApi: Send + Sync {
    ...
    ///
    /// 
    async fn celestia_service_get_blob(&self,  params: CelestiaServiceGetBlobParams ) -> Result<ResponseContent<CelestiaServiceGetBlobSuccess>, Error<CelestiaServiceGetBlobError>>;

    /// GET /api/v1/celestia/l2BatchMetadata
    ///
    /// 
    async fn celestia_service_get_l2_batch_metadata(&self,  params: CelestiaServiceGetL2BatchMetadataParams ) -> Result<ResponseContent<CelestiaServiceGetL2BatchMetadataSuccess>, Error<CelestiaServiceGetL2BatchMetadataError>>;

    /// GET /api/v2/health
    ///
    /// 
    async fn health_check(&self,  params: HealthCheckParams ) -> Result<ResponseContent<HealthCheckSuccess>, Error<HealthCheckError>>;
}
...
impl CelestiaServiceApi for CelestiaServiceApiClient {
    async fn celestia_service_get_blob(&self,  params: CelestiaServiceGetBlobParams ) -> Result<ResponseContent<CelestiaServiceGetBlobSuccess>, Error<CelestiaServiceGetBlobError>> {
        ...
        let local_var_uri_str = format!("{}/api/v1/celestia/blob", local_var_configuration.base_path);
        ...
        if let Some(ref local_var_str) = commitment {
            local_var_req_builder = local_var_req_builder.query(&[("commitment", &local_var_str.to_string())]);
        }
        if let Some(ref local_var_str) = skip_data {
            local_var_req_builder = local_var_req_builder.query(&[("skipData", &local_var_str.to_string())]);
        }
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<CelestiaServiceGetBlobSuccess> = serde_json::from_str(&local_var_content).ok();
            let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Ok(local_var_result)
        } else {
            let local_var_entity: Option<CelestiaServiceGetBlobError> = serde_json::from_str(&local_var_content).ok();
    ...
    async fn celestia_service_get_l2_batch_metadata(&self,  params: CelestiaServiceGetL2BatchMetadataParams ) -> Result<ResponseContent<CelestiaServiceGetL2BatchMetadataSuccess>, Error<CelestiaServiceGetL2BatchMetadataError>> {
        ...
        let local_var_uri_str = format!("{}/api/v1/celestia/l2BatchMetadata", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<CelestiaServiceGetL2BatchMetadataSuccess> = serde_json::from_str(&local_var_content).ok();
            let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Ok(local_var_result)
        } else {
            let local_var_entity: Option<CelestiaServiceGetL2BatchMetadataError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
...
impl ResponseContent<CelestiaServiceGetBlobSuccess> {
    ...
    pub fn try_parse_as_success_model(&self) -> Result<models::V1CelestiaBlob, serde_json_path_to_error::Error> {
...
impl ResponseContent<CelestiaServiceGetL2BatchMetadataSuccess> {
    ...
    pub fn try_parse_as_success_model(&self) -> Result<models::V1CelestiaL2BatchMetadata, serde_json_path_to_error::Error> {
        serde_json_path_to_error::from_str(&self.content)
    }
}
