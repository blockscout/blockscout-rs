...
pub trait AddressesApi: Send + Sync {
    ...
    ///
    /// 
    async fn get_address(&self,  params: GetAddressParams ) -> Result<ResponseContent<GetAddressSuccess>, Error<GetAddressError>>;

    /// GET /api/v2/addresses/{address_hash}/blocks-validated
    ///
    /// 
    async fn get_address_blocks_validated(&self,  params: GetAddressBlocksValidatedParams ) -> Result<ResponseContent<GetAddressBlocksValidatedSuccess>, Error<GetAddressBlocksValidatedError>>;

    /// GET /api/v2/addresses/{address_hash}/coin-balance-history
    ///
    /// 
    async fn get_address_coin_balance_history(&self,  params: GetAddressCoinBalanceHistoryParams ) -> Result<ResponseContent<GetAddressCoinBalanceHistorySuccess>, Error<GetAddressCoinBalanceHistoryError>>;

    /// GET /api/v2/addresses/{address_hash}/coin-balance-history-by-day
    ///
    /// 
    async fn get_address_coin_balance_history_by_day(&self,  params: GetAddressCoinBalanceHistoryByDayParams ) -> Result<ResponseContent<GetAddressCoinBalanceHistoryByDaySuccess>, Error<GetAddressCoinBalanceHistoryByDayError>>;

    /// GET /api/v2/addresses/{address_hash}/counters
    ///
    /// 
    async fn get_address_counters(&self,  params: GetAddressCountersParams ) -> Result<ResponseContent<GetAddressCountersSuccess>, Error<GetAddressCountersError>>;

    /// GET /api/v2/addresses/{address_hash}/internal-transactions
    ///
    /// 
    async fn get_address_internal_txs(&self,  params: GetAddressInternalTxsParams ) -> Result<ResponseContent<GetAddressInternalTxsSuccess>, Error<GetAddressInternalTxsError>>;

    /// GET /api/v2/addresses/{address_hash}/logs
    ///
    /// 
    async fn get_address_logs(&self,  params: GetAddressLogsParams ) -> Result<ResponseContent<GetAddressLogsSuccess>, Error<GetAddressLogsError>>;

    /// GET /api/v2/addresses/{address_hash}/nft
    ///
    /// 
    async fn get_address_nft(&self,  params: GetAddressNftParams ) -> Result<ResponseContent<GetAddressNftSuccess>, Error<GetAddressNftError>>;

    /// GET /api/v2/addresses/{address_hash}/nft/collections
    ///
    /// 
    async fn get_address_nft_collections(&self,  params: GetAddressNftCollectionsParams ) -> Result<ResponseContent<GetAddressNftCollectionsSuccess>, Error<GetAddressNftCollectionsError>>;

    /// GET /api/v2/addresses/{address_hash}/token-balances
    ///
    /// 
    async fn get_address_token_balances(&self,  params: GetAddressTokenBalancesParams ) -> Result<ResponseContent<GetAddressTokenBalancesSuccess>, Error<GetAddressTokenBalancesError>>;

    /// GET /api/v2/addresses/{address_hash}/token-transfers
    ///
    /// 
    async fn get_address_token_transfers(&self,  params: GetAddressTokenTransfersParams ) -> Result<ResponseContent<GetAddressTokenTransfersSuccess>, Error<GetAddressTokenTransfersError>>;

    /// GET /api/v2/addresses/{address_hash}/tokens
    ///
    /// 
    async fn get_address_tokens(&self,  params: GetAddressTokensParams ) -> Result<ResponseContent<GetAddressTokensSuccess>, Error<GetAddressTokensError>>;

    /// GET /api/v2/addresses/{address_hash}/transactions
    ///
    /// 
    async fn get_address_txs(&self,  params: GetAddressTxsParams ) -> Result<ResponseContent<GetAddressTxsSuccess>, Error<GetAddressTxsError>>;

    /// GET /api/v2/addresses/{address_hash}/withdrawals
    ///
    /// 
    async fn get_address_withdrawals(&self,  params: GetAddressWithdrawalsParams ) -> Result<ResponseContent<GetAddressWithdrawalsSuccess>, Error<GetAddressWithdrawalsError>>;

    /// GET /api/v2/addresses
    ///
    /// 
    async fn get_addresses(&self, ) -> Result<ResponseContent<GetAddressesSuccess>, Error<GetAddressesError>>;
}
...
impl AddressesApi for AddressesApiClient {
    async fn get_address(&self,  params: GetAddressParams ) -> Result<ResponseContent<GetAddressSuccess>, Error<GetAddressError>> {
        ...
        let local_var_uri_str = format!("{}/api/v2/addresses/{address_hash}", local_var_configuration.base_path, address_hash=crate::apis::urlencode(address_hash));
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<GetAddressSuccess> = serde_json::from_str(&local_var_content).ok();
    ...
    async fn get_address_blocks_validated(&self,  params: GetAddressBlocksValidatedParams ) -> Result<ResponseContent<GetAddressBlocksValidatedSuccess>, Error<GetAddressBlocksValidatedError>> {
        ...
        let GetAddressBlocksValidatedParams {
            address_hash,
        } = params;
        ...
        let local_var_uri_str = format!("{}/api/v2/addresses/{address_hash}/blocks-validated", local_var_configuration.base_path, address_hash=crate::apis::urlencode(address_hash));
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<GetAddressBlocksValidatedSuccess> = serde_json::from_str(&local_var_content).ok();
            let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Ok(local_var_result)
        } else {
            let local_var_entity: Option<GetAddressBlocksValidatedError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_address_coin_balance_history(&self,  params: GetAddressCoinBalanceHistoryParams ) -> Result<ResponseContent<GetAddressCoinBalanceHistorySuccess>, Error<GetAddressCoinBalanceHistoryError>> {
        ...
        let GetAddressCoinBalanceHistoryParams {
            address_hash,
        } = params;
        ...
        let local_var_uri_str = format!("{}/api/v2/addresses/{address_hash}/coin-balance-history", local_var_configuration.base_path, address_hash=crate::apis::urlencode(address_hash));
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<GetAddressCoinBalanceHistorySuccess> = serde_json::from_str(&local_var_content).ok();
            let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Ok(local_var_result)
        } else {
            let local_var_entity: Option<GetAddressCoinBalanceHistoryError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_address_coin_balance_history_by_day(&self,  params: GetAddressCoinBalanceHistoryByDayParams ) -> Result<ResponseContent<GetAddressCoinBalanceHistoryByDaySuccess>, Error<GetAddressCoinBalanceHistoryByDayError>> {
        ...
        let GetAddressCoinBalanceHistoryByDayParams {
            address_hash,
        } = params;
        ...
        let local_var_uri_str = format!("{}/api/v2/addresses/{address_hash}/coin-balance-history-by-day", local_var_configuration.base_path, address_hash=crate::apis::urlencode(address_hash));
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<GetAddressCoinBalanceHistoryByDaySuccess> = serde_json::from_str(&local_var_content).ok();
            let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Ok(local_var_result)
        } else {
            let local_var_entity: Option<GetAddressCoinBalanceHistoryByDayError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_address_counters(&self,  params: GetAddressCountersParams ) -> Result<ResponseContent<GetAddressCountersSuccess>, Error<GetAddressCountersError>> {
        ...
        let local_var_uri_str = format!("{}/api/v2/addresses/{address_hash}/counters", local_var_configuration.base_path, address_hash=crate::apis::urlencode(address_hash));
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<GetAddressCountersSuccess> = serde_json::from_str(&local_var_content).ok();
            let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Ok(local_var_result)
        } else {
            let local_var_entity: Option<GetAddressCountersError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_address_internal_txs(&self,  params: GetAddressInternalTxsParams ) -> Result<ResponseContent<GetAddressInternalTxsSuccess>, Error<GetAddressInternalTxsError>> {
        ...
        let local_var_uri_str = format!("{}/api/v2/addresses/{address_hash}/internal-transactions", local_var_configuration.base_path, address_hash=crate::apis::urlencode(address_hash));
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<GetAddressInternalTxsSuccess> = serde_json::from_str(&local_var_content).ok();
            let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Ok(local_var_result)
        } else {
            let local_var_entity: Option<GetAddressInternalTxsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_address_logs(&self,  params: GetAddressLogsParams ) -> Result<ResponseContent<GetAddressLogsSuccess>, Error<GetAddressLogsError>> {
        ...
        let local_var_uri_str = format!("{}/api/v2/addresses/{address_hash}/logs", local_var_configuration.base_path, address_hash=crate::apis::urlencode(address_hash));
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<GetAddressLogsSuccess> = serde_json::from_str(&local_var_content).ok();
            let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Ok(local_var_result)
        } else {
            let local_var_entity: Option<GetAddressLogsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_address_nft(&self,  params: GetAddressNftParams ) -> Result<ResponseContent<GetAddressNftSuccess>, Error<GetAddressNftError>> {
        ...
        let local_var_uri_str = format!("{}/api/v2/addresses/{address_hash}/nft", local_var_configuration.base_path, address_hash=crate::apis::urlencode(address_hash));
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<GetAddressNftSuccess> = serde_json::from_str(&local_var_content).ok();
            let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Ok(local_var_result)
        } else {
            let local_var_entity: Option<GetAddressNftError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_address_nft_collections(&self,  params: GetAddressNftCollectionsParams ) -> Result<ResponseContent<GetAddressNftCollectionsSuccess>, Error<GetAddressNftCollectionsError>> {
        ...
        let local_var_uri_str = format!("{}/api/v2/addresses/{address_hash}/nft/collections", local_var_configuration.base_path, address_hash=crate::apis::urlencode(address_hash));
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<GetAddressNftCollectionsSuccess> = serde_json::from_str(&local_var_content).ok();
            let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Ok(local_var_result)
        } else {
            let local_var_entity: Option<GetAddressNftCollectionsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_address_token_balances(&self,  params: GetAddressTokenBalancesParams ) -> Result<ResponseContent<GetAddressTokenBalancesSuccess>, Error<GetAddressTokenBalancesError>> {
        ...
        let GetAddressTokenBalancesParams {
            address_hash,
        } = params;
        ...
        let local_var_uri_str = format!("{}/api/v2/addresses/{address_hash}/token-balances", local_var_configuration.base_path, address_hash=crate::apis::urlencode(address_hash));
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<GetAddressTokenBalancesSuccess> = serde_json::from_str(&local_var_content).ok();
            let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Ok(local_var_result)
        } else {
            let local_var_entity: Option<GetAddressTokenBalancesError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_address_token_transfers(&self,  params: GetAddressTokenTransfersParams ) -> Result<ResponseContent<GetAddressTokenTransfersSuccess>, Error<GetAddressTokenTransfersError>> {
        ...
        let local_var_uri_str = format!("{}/api/v2/addresses/{address_hash}/token-transfers", local_var_configuration.base_path, address_hash=crate::apis::urlencode(address_hash));
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<GetAddressTokenTransfersSuccess> = serde_json::from_str(&local_var_content).ok();
            let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Ok(local_var_result)
        } else {
            let local_var_entity: Option<GetAddressTokenTransfersError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_address_tokens(&self,  params: GetAddressTokensParams ) -> Result<ResponseContent<GetAddressTokensSuccess>, Error<GetAddressTokensError>> {
        ...
        let local_var_uri_str = format!("{}/api/v2/addresses/{address_hash}/tokens", local_var_configuration.base_path, address_hash=crate::apis::urlencode(address_hash));
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<GetAddressTokensSuccess> = serde_json::from_str(&local_var_content).ok();
            let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Ok(local_var_result)
        } else {
            let local_var_entity: Option<GetAddressTokensError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_address_txs(&self,  params: GetAddressTxsParams ) -> Result<ResponseContent<GetAddressTxsSuccess>, Error<GetAddressTxsError>> {
        ...
        let local_var_uri_str = format!("{}/api/v2/addresses/{address_hash}/transactions", local_var_configuration.base_path, address_hash=crate::apis::urlencode(address_hash));
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<GetAddressTxsSuccess> = serde_json::from_str(&local_var_content).ok();
            let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Ok(local_var_result)
        } else {
            let local_var_entity: Option<GetAddressTxsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_address_withdrawals(&self,  params: GetAddressWithdrawalsParams ) -> Result<ResponseContent<GetAddressWithdrawalsSuccess>, Error<GetAddressWithdrawalsError>> {
        ...
        let GetAddressWithdrawalsParams {
            address_hash,
        } = params;
        ...
        let local_var_uri_str = format!("{}/api/v2/addresses/{address_hash}/withdrawals", local_var_configuration.base_path, address_hash=crate::apis::urlencode(address_hash));
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<GetAddressWithdrawalsSuccess> = serde_json::from_str(&local_var_content).ok();
            let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Ok(local_var_result)
        } else {
            let local_var_entity: Option<GetAddressWithdrawalsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_addresses(&self, ) -> Result<ResponseContent<GetAddressesSuccess>, Error<GetAddressesError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<GetAddressesSuccess> = serde_json::from_str(&local_var_content).ok();
            let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Ok(local_var_result)
        } else {
            let local_var_entity: Option<GetAddressesError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
...
impl ResponseContent<GetAddressSuccess> {
    ...
    pub fn try_parse_as_success_model(&self) -> Result<models::Address, serde_json_path_to_error::Error> {
...
impl ResponseContent<GetAddressBlocksValidatedSuccess> {
    ...
    pub fn try_parse_as_success_model(&self) -> Result<models::GetAddressBlocksValidated200Response, serde_json_path_to_error::Error> {
        serde_json_path_to_error::from_str(&self.content)
    }
}
...
impl ResponseContent<GetAddressCoinBalanceHistorySuccess> {
    ...
    pub fn try_parse_as_success_model(&self) -> Result<models::GetAddressCoinBalanceHistory200Response, serde_json_path_to_error::Error> {
        serde_json_path_to_error::from_str(&self.content)
    }
}
...
impl ResponseContent<GetAddressCoinBalanceHistoryByDaySuccess> {
    ...
    pub fn try_parse_as_success_model(&self) -> Result<Vec<models::CoinBalanceHistoryByDaysEntry>, serde_json_path_to_error::Error> {
        serde_json_path_to_error::from_str(&self.content)
    }
}
...
impl ResponseContent<GetAddressCountersSuccess> {
    ...
    pub fn try_parse_as_success_model(&self) -> Result<models::AddressCounters, serde_json_path_to_error::Error> {
        serde_json_path_to_error::from_str(&self.content)
    }
}
...
impl ResponseContent<GetAddressInternalTxsSuccess> {
    ...
    pub fn try_parse_as_success_model(&self) -> Result<models::GetAddressInternalTxs200Response, serde_json_path_to_error::Error> {
        serde_json_path_to_error::from_str(&self.content)
    }
}
...
impl ResponseContent<GetAddressLogsSuccess> {
    ...
    pub fn try_parse_as_success_model(&self) -> Result<models::GetAddressLogs200Response, serde_json_path_to_error::Error> {
        serde_json_path_to_error::from_str(&self.content)
    }
}
...
impl ResponseContent<GetAddressNftSuccess> {
    ...
    pub fn try_parse_as_success_model(&self) -> Result<models::GetAddressNft200Response, serde_json_path_to_error::Error> {
        serde_json_path_to_error::from_str(&self.content)
    }
}
...
impl ResponseContent<GetAddressNftCollectionsSuccess> {
    ...
    pub fn try_parse_as_success_model(&self) -> Result<models::GetAddressNftCollections200Response, serde_json_path_to_error::Error> {
        serde_json_path_to_error::from_str(&self.content)
    }
}
...
impl ResponseContent<GetAddressTokenBalancesSuccess> {
    ...
    pub fn try_parse_as_success_model(&self) -> Result<Vec<models::TokenBalance>, serde_json_path_to_error::Error> {
        serde_json_path_to_error::from_str(&self.content)
    }
}
...
impl ResponseContent<GetAddressTokenTransfersSuccess> {
    ...
    pub fn try_parse_as_success_model(&self) -> Result<models::GetAddressTokenTransfers200Response, serde_json_path_to_error::Error> {
        serde_json_path_to_error::from_str(&self.content)
    }
}
...
impl ResponseContent<GetAddressTokensSuccess> {
    ...
    pub fn try_parse_as_success_model(&self) -> Result<models::GetAddressTokens200Response, serde_json_path_to_error::Error> {
        serde_json_path_to_error::from_str(&self.content)
    }
}
...
impl ResponseContent<GetAddressesSuccess> {
    ...
    pub fn try_parse_as_success_model(&self) -> Result<models::GetAddresses200Response, serde_json_path_to_error::Error> {
        serde_json_path_to_error::from_str(&self.content)
    }
}
