...
pub trait BlocksApi: Send + Sync {
    ...
    ) -> Result<ResponseContent<GetBlocksSuccess>, Error<GetBlocksError>>;
}
...
impl BlocksApi for BlocksApiClient {
    async fn get_block(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<GetBlockSuccess> =
            ...
            let local_var_entity: Option<GetBlockError> =
                serde_json::from_str(&local_var_content).ok();
    ...
    async fn get_block_txs(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<GetBlockTxsSuccess> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_result = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    async fn get_block_withdrawals(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<GetBlockWithdrawalsSuccess> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_result = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    async fn get_blocks(
        ...
        let GetBlocksParams { r#type } = params;
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<GetBlocksSuccess> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_result = ResponseContent {
                status: local_var_status,
                content: local_var_content,
...
impl ResponseContent<GetBlockSuccess> {
    ...
    pub fn try_parse_as_success_model(
        &self,
    ) -> Result<models::Block, serde_json_path_to_error::Error> {
...
impl ResponseContent<GetBlocksSuccess> {
    ...
    pub fn try_parse_as_success_model(
        &self,
    ) -> Result<models::GetBlocks200Response, serde_json_path_to_error::Error> {
        serde_json_path_to_error::from_str(&self.content)
    }
}
