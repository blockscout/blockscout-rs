...
impl ApiClient {
    ...
    pub fn new_arc(configuration: Arc<configuration::Configuration>) -> Self {
        Self {
            addresses_api: Box::new(addresses_api::AddressesApiClient::new(configuration.clone())),
            blocks_api: Box::new(blocks_api::BlocksApiClient::new(configuration.clone())),
            celestia_service_api: Box::new(celestia_service_api::CelestiaServiceApiClient::new(configuration.clone())),
            ...
            internal_transactions_api: Box::new(internal_transactions_api::InternalTransactionsApiClient::new(configuration.clone())),
            ...
            smart_contracts_api: Box::new(smart_contracts_api::SmartContractsApiClient::new(configuration.clone())),
            stats_api: Box::new(stats_api::StatsApiClient::new(configuration.clone())),
            token_transfers_api: Box::new(token_transfers_api::TokenTransfersApiClient::new(configuration.clone())),
            ...
            withdrawals_api: Box::new(withdrawals_api::WithdrawalsApiClient::new(configuration.clone())),
        }
    }
    // changed
...
impl MockApiClient {
    pub fn new() -> Self {
        Self {
            ...
            internal_transactions_api_mock: internal_transactions_api::MockInternalTransactionsApi::new(),
