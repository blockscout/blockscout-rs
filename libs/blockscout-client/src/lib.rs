...
pub mod address_counters {
    include!("./address_counters.rs");
}

pub mod address_param {
    include!("./address_param.rs");
}

pub mod address_tag {
    include!("./address_tag.rs");
}
...
pub mod coin_balance_history_by_days_entry {
    include!("./coin_balance_history_by_days_entry.rs");
}

pub mod coin_balance_history_entry {
    include!("./coin_balance_history_entry.rs");
}

pub mod constructor_arguments {
    include!("./constructor_arguments.rs");
}

pub mod decoded_input {
    include!("./decoded_input.rs");
}

pub mod decoded_input_log {
    include!("./decoded_input_log.rs");
}

pub mod decoded_input_log_parameter {
    include!("./decoded_input_log_parameter.rs");
}

pub mod decoded_input_parameter {
    include!("./decoded_input_parameter.rs");
}

pub mod extended_revert_reason_as_map {
    include!("./extended_revert_reason_as_map.rs");
}
...
pub mod get_addresses_address_hash_blocks_validated_response {
    include!("./get_addresses_address_hash_blocks_validated_response.rs");
}

pub mod get_addresses_address_hash_coin_balance_history_response {
    include!("./get_addresses_address_hash_coin_balance_history_response.rs");
}

pub mod get_addresses_address_hash_internal_transactions_response {
    include!("./get_addresses_address_hash_internal_transactions_response.rs");
}

pub mod get_addresses_address_hash_logs_response {
    include!("./get_addresses_address_hash_logs_response.rs");
}

pub mod get_addresses_address_hash_token_transfers_response {
    include!("./get_addresses_address_hash_token_transfers_response.rs");
}

pub mod get_addresses_address_hash_tokens_response {
    include!("./get_addresses_address_hash_tokens_response.rs");
}

pub mod get_addresses_address_hash_transactions_response {
    include!("./get_addresses_address_hash_transactions_response.rs");
}

pub mod get_addresses_response {
    include!("./get_addresses_response.rs");
}

pub mod get_blocks_block_number_or_hash_transactions_response {
    include!("./get_blocks_block_number_or_hash_transactions_response.rs");
}

pub mod get_blocks_response {
    include!("./get_blocks_response.rs");
}

pub mod get_config_json_rpc_url_response {
    include!("./get_config_json_rpc_url_response.rs");
}

pub mod get_search_response {
    include!("./get_search_response.rs");
}

pub mod get_smart_contracts_counters_response {
    include!("./get_smart_contracts_counters_response.rs");
}

pub mod get_smart_contracts_response {
    include!("./get_smart_contracts_response.rs");
}

pub mod get_stats_charts_market_response {
    include!("./get_stats_charts_market_response.rs");
}

pub mod get_stats_charts_transactions_response {
    include!("./get_stats_charts_transactions_response.rs");
}

pub mod get_tokens_address_hash_holders_response {
    include!("./get_tokens_address_hash_holders_response.rs");
}

pub mod get_tokens_address_hash_instances_id_transfers_count_response {
    include!("./get_tokens_address_hash_instances_id_transfers_count_response.rs");
}

pub mod get_tokens_address_hash_instances_id_transfers_response {
    include!("./get_tokens_address_hash_instances_id_transfers_response.rs");
}

pub mod get_tokens_address_hash_instances_response {
    include!("./get_tokens_address_hash_instances_response.rs");
}

pub mod get_tokens_address_hash_token_transfers_response {
    include!("./get_tokens_address_hash_token_transfers_response.rs");
}

pub mod get_tokens_response {
    include!("./get_tokens_response.rs");
}

pub mod get_transactions_response {
    include!("./get_transactions_response.rs");
}

pub mod get_transactions_transaction_hash_internal_transactions_response {
    include!("./get_transactions_transaction_hash_internal_transactions_response.rs");
}

pub mod get_transactions_transaction_hash_logs_response {
    include!("./get_transactions_transaction_hash_logs_response.rs");
}

pub mod get_transactions_transaction_hash_token_transfers_response {
    include!("./get_transactions_transaction_hash_token_transfers_response.rs");
}

pub mod internal_transaction {
    include!("./internal_transaction.rs");
}
...
pub mod raw_trace {
    include!("./raw_trace.rs");
}

pub mod read_method_with_value {
    include!("./read_method_with_value.rs");
}

pub mod read_method_without_value {
    include!("./read_method_without_value.rs");
}

pub mod revert_reason_as_map {
    include!("./revert_reason_as_map.rs");
}
...
pub mod token_balance {
    include!("./token_balance.rs");
}

pub mod token_transfer {
    include!("./token_transfer.rs");
}
...
pub mod transaction_reward {
    include!("./transaction_reward.rs");
}

pub mod watchlist_name {
    include!("./watchlist_name.rs");
}

pub mod write_method {
    include!("./write_method.rs");
}
...
pub mod client {
    ...
    impl ApiClient for reqwest::Client {
        ...
        fn request_builder(&self, method: http::Method, rel_path: &str) -> Self::Request {
            let mut u = String::from("https://blockscout.com/poa/core/api/v2/");
