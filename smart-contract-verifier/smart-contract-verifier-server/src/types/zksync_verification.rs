...
//     self, CompilationFailure, VerifyResponse,
// };
...
//             solidity::verify_response::VerifyResponse::CompilationFailure(CompilationFailure {
...
//                 solidity::VerificationFailure {
//                     message: "No contract could be verified with provided data".into(),
//                 },
//             )
//         }
...
// }
//
// pub fn process_batch_error(error: BatchError) -> Result<Response<VerifyResponse>, Status> {
//     match error {
