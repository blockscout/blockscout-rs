...
// }
//
// struct ZkListVersionFetcher {
//     list_url: Url,
// }
//
// impl ZkListVersionFetcher {
//     fn new(list_url: Url) -> Self {
//         Self { list_url }
//     }
//
//     async fn fetch_json_versions(&self) -> Result<json::List, ZkListError> {
//         reqwest::get(self.list_url.as_str())
//             .await
//             .map_err(ZkListError::ListJsonFetch)?
//             .json()
//             .await
//             .map_err(ZkListError::ParseListJson)
//     }
//
//     fn parse_json_versions(&self, list_json: json::List) -> Result<VersionsMap, ZkListError> {
...
//
// #[async_trait]
// impl VersionsFetcher for ZkListVersionFetcher {
//     type Versions = VersionsMap;
//     type Error = ZkListError;
//
...
//         validator: Option<Arc<dyn FileValidator>>,
//     ) -> anyhow::Result<Self> {
//         let fetcher = Arc::new(ZkListVersionFetcher::new(list_url));
...
//
// #[async_trait]
// impl Fetcher for ZkListFetcher {
...
// mod tests {
//     use super::*;
//     use crate::{consts::DEFAULT_SOLIDITY_COMPILER_LIST, DEFAULT_ZKSOLC_COMPILER_LIST, tests::parse::test_deserialize_ok};
...
//     //     let fetcher = ZkListVersionFetcher::new(download_url);
...
//         let list_url = Url::try_from(DEFAULT_ZKSOLC_COMPILER_LIST).expect("valid url");
//         let fetcher = ZkListFetcher::new(
//             list_url,
//             temp_dir().join("blockscout/smart_contract_verifier/zk_compiler_fetcher/test/"),
//             None,
//             None,
//         )
//             .await
