...
/// Chart that is only directly dependant on [`RemoteSource`](crate::data_source::kinds::remote::RemoteSource)
/// data source. It means it directly stores data obtained from the source.
