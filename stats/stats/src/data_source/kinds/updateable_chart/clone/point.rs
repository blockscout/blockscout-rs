...
use crate::{
    data_source::{kinds::updateable_chart::UpdateableChartWrapper, DataSource},
    Chart, DateValueString,
};
...
pub type ClonePointChartWrapper<T> = UpdateableChartWrapper<_inner::ClonePointChartLocalWrapper<T>>;
...
mod _inner {
    ...
    use crate::{
        ...
        data_source::{kinds::updateable_chart::UpdateableChart, DataSource},
        Chart, DateValueString, Named, UpdateError,
    };

    use super::ClonePointChart;

    /// Wrapper to get type implementing "parent" trait. Use [`super::ClonePointChartWrapper`] to get [`DataSource`]
