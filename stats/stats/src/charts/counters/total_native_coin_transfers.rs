use crate::data_source::kinds::updateable_chart::UpdateableChartWrapper;

mod _inner {
    use crate::{
        charts::db_interaction::write::insert_data_many,
        data_processing::parse_and_sum,
        data_source::{kinds::updateable_chart::UpdateableChart, DataSource, UpdateContext},
...
pub type TotalNativeCoinTransfers = UpdateableChartWrapper<_inner::TotalNativeCoinTransfersInner>;
