...
MIGRATION_NAME="$1"
MIGRATION_DIR="blockscout-smart-contracts-migration"
...
# The output format is: "Creating migration file `blockscout-smart-contracts-migration/src/m20250801_123141_hello.rs`"
...
# From: blockscout-smart-contracts-migration/src/m20250801_123141_hello.rs
