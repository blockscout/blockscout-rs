...
fn compile(
    ...
    config
        ...
        .protoc_arg("grpc_api_configuration=proto/v1/api_config_http.yaml,output_format=yaml,allow_merge=true,merge_file_name=stylus-verifier,json_names_for_fields=false")
        .bytes(["."])
        .btree_map(["."])
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    compile(
        &[
            ...
            "proto/v1/stylus-verifier.proto",
        ],
        &["../../proto", "proto"],
        gens,
    )?;
