...
|--------------------------------------------------------|----------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|
| `ETH_BYTECODE_DB__DATABASE__CONNECT__URL`              | true     | Postgres connect URL to internal database with read/write access                                                                                                      | (empty)                        |
| `ETH_BYTECODE_DB__DATABASE__CONNECT_OPTIONS__MAX_CONNECTIONS` |   | Maximum number of connections in the internal database pool                                                                                                           | `10`                           |
| `ETH_BYTECODE_DB__DATABASE__CONNECT_OPTIONS__ACQUIRE_TIMEOUT` |   | Seconds to wait for a connection from the internal database pool                                                                                                      | `30`                           |
...
| `ETH_BYTECODE_DB__VERIFIER_ALLIANCE_DATABASE__CONNECT_OPTIONS__MAX_CONNECTIONS` | | Maximum number of connections in the verifier alliance database pool                                                                        | `10`                           |
