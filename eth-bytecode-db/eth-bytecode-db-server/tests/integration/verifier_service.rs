...
#[async_trait]
pub trait VerifierServiceOld<Request, Response> {
    ...
    > for MockSolidityVerifierService
{
    ...
    fn add_into_service(&mut self, response: smart_contract_verifier_v2::BatchVerifyResponse) {
        self.expect_batch_verify_standard_json()
            .returning(move |_| Ok(Response::new(response.clone())));
    }
